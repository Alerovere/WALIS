quality1 = quality[quality['Region'] == Region1.value]
quality2 = quality[quality['Region'] == Region2.value]
...
axes[0].set_title(Region1.value)
axes[1].set_title(Region2.value)


filename1='Output/Images/svg/Quality'+str(Region1.value)+'_'+str(Region2.value)+'.svg'
